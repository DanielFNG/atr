...
%     0.89, 6.61]';
emg = -[-52.3710, -3.8178, 19.9863, -0.4214, 29.1339, 40.4402, 6.1145, ...
    -10.9369, -27.4397, -7.9652, -20.5088, 7.7883, 31.2803, -43.8009, ...
    33.2725, 13.7588, 21.0505, 9.9270, -39.1640, 3.5048, -3.4220]';
...
shank_emg = -[0.9507, 3.9689, 17.8176, 21.8816, -12.1381, 1.1129, ...
    -16.6262, 41.9123, 11.3133, 29.3092, 12.6784, 9.1899]';
% shank_locs = [0.5, 11.5, 2.5, 7.5, 1.5, 8.5, 4.5, 5.5, 10.5, 3.5, 9.5, ...
%     6.5]';
shank_locs = (0.5:1.0:11.5)';
shank_T = sortrows(table(shank_locs, shank_emg));


% Fit the GP's.
rng default
gpfit_sextic = fitrgp(T, 'emg', 'BasisFunction', @quinticBasis, 'Beta', 1, 'KernelFunction', 'squaredexponential');
