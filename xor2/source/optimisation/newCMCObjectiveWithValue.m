function value = newCMCObjectiveWithValue(thigh, shank)
...
save_dir = ['D:\Dropbox\PhD\Robio 2018\Data\BayesOpt' filesep 'thigh=' num2str(thigh) ...
    'shank=' num2str(shank)];
...
for i=1:3
    success = cmc.run();
    if success
        result = CMCResults([results_folder filesep 'XoR2-Human'], 1);
    ...
    gas_metabolic_power = 50;
end

value = gas_metabolic_power;
